    ...
    <section ref={sectionRef} id="equipe" className="py-12 md:py-16 overflow-hidden" 
      ...
      <div className="max-w-[1440px] mx-auto px-8 md:px-[32px]">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-4xl md:text-5xl font-raleway font-bold leading-tight tracking-tight">
            <span className="text-[#5A5A5A]">La nostra</span><br className="md:hidden" /> <span className="text-[#BDBDBD]">equipe medica</span>
          </h2>
        </div>
